...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/YASIRALIMEKKAN")
	subprocess.check_output(["am", "start", "https://github.com/Yasirkhani/Yasir-king/blob/main/Aprove.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Yasirkhani/Yasir-king/blob/main/Aprove.txt').text
			if basesplit in plr:
				key = basesplit
